setwd("C:\\Users\\Adinath\\Desktop\\Data_Science\\Assignments\\Random Forests")
...
company <- read.csv("C:\\Users\\Adinath\\Desktop\\Data_Science\\Assignments\\Random Forests\\Company_Data.csv")
head(company)
nrow(company)
str(company)
...
df = read.csv("C:\\Users\\Adinath\\Desktop\\Data_Science\\Assignments\\Random Forests\\Fraud_check.csv")
head(df)
