...
book <- read.csv("C:\\Users\\Adinath\\Desktop\\Data_Science\\Assignments\\Association_Rules\\book.csv")
...
groceries <- read.transactions("C:\\Users\\Adinath\\Desktop\\Data_Science\\Assignments\\Association_Rules\\groceries.csv",sep = ",")
...
movies <- read.csv("C:\\Users\\Adinath\\Desktop\\Data_Science\\Assignments\\Association_Rules\\my_movies.csv")
head(movies)
