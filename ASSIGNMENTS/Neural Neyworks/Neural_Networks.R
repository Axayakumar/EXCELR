setwd("C:\\Users\\Adinath\\Desktop\\Data_Science\\Assignments\\Neural Networks")
...
statups <- read.csv("C:\\Users\\Adinath\\Desktop\\Data_Science\\Assignments\\Neural Networks\\50_Startups.csv")
head(statups)
str(statups)
# Target is Profit
plot(statups[,-4])
