setwd("C:\\Users\\Adinath\\Desktop\\Data_Science\\Assignments\\basics_statistics_level1")
# Question 7 
q7 <- read.csv("C:\\Users\\Adinath\\Desktop\\Data_Science\\Assignments\\basics_statistics_level1\\Q7.csv")
df_1 = q7[,2:4]
head(df_1,2)
summary(df_1)
