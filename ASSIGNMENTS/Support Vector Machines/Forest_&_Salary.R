...
forestfire <- read.csv("C:\\Users\\Adinath\\Desktop\\Data_Science\\Assignments\\Support Vector Machines\\forestfires.csv")
head(forestfire)
str(forestfire)
dim(forestfire)
...
train_salary <- read.csv("C:\\Users\\Adinath\\Desktop\\Data_Science\\Assignments\\Support Vector Machines\\SalaryData_Train(1).csv")
test_salary <- read.csv("C:\\Users\\Adinath\\Desktop\\Data_Science\\Assignments\\Support Vector Machines\\SalaryData_Test(1).csv")
